...
// g++ Fit_VSH_series_no_r_dependence_03.cpp -o Fit_VSH_series_no_r_dependence_03

/*
Fit a vector spherical harmonic series to a vector A(theta,phi).
As code _01, but allowing for A to be complex. (Skipping over code _02 as it is incomplete.)
*/
...
#include "../Headers_VSH_series/VSH_series_calculation_10.h"	// Works up to _04 inclusive, andr from _06 inclusive.
#include "../Headers_VSH_series/VSH_series_evaluation_04.h"		// Works up to _04 inclusive.
