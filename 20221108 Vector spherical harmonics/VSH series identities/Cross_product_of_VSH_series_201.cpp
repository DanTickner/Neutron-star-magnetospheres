...
// g++ Cross_product_of_VSH_series_201.cpp -o Cross_product_of_VSH_series_201
...
The product-of-sum identities only work for single sums, so reparameterise (ell,m) to k, such that ell=floor(sqrt(k)) and m=k-ell(ell+1). See Excel sheet in Probationary Review folder for empirical verification of this parameterisation.
*/
