...
// g++ Cross_product_of_VSH_series_103b.cpp -o Cross_product_of_VSH_series_103b
...
Replace the double sum by a single sum over k, which should yield the same result.
*/
