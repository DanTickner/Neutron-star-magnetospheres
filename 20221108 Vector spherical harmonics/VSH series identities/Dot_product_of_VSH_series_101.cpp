...
// g++ Dot_product_of_VSH_series_101.cpp -o Dot_product_of_VSH_series_101
...
Code is taken from Cross_product_of_VSH_series_201 and modified for dot products.
*/
...
int main(){
	...
	std::complex<double> dot_product_from_VSH_coeffs_20 = 0;
	...
	for( int k1=0; k1<=k_max; k1++ ){
		...
		for( int k2=0; k2<=k_max; k2++ ){	
			...
			dot_product_from_VSH_coeffs_01 += Ar12[0] * Br12[1] * dot_product( Y1  , Psi2 );
			dot_product_from_VSH_coeffs_02 += Ar12[0] * Br12[2] * dot_product( Y1  , Phi2 );
			dot_product_from_VSH_coeffs_10 += Ar12[1] * Br12[0] * dot_product( Psi1, Y2   );
			...
			dot_product_from_VSH_coeffs_20 += Ar12[2] * Br12[0] * dot_product( Phi1, Y2   );
	...
	dot_product_from_VSH_coeffs +=  dot_product_from_VSH_coeffs_01;
	dot_product_from_VSH_coeffs +=  dot_product_from_VSH_coeffs_02;
	dot_product_from_VSH_coeffs +=  dot_product_from_VSH_coeffs_10;
	dot_product_from_VSH_coeffs +=  dot_product_from_VSH_coeffs_11;
	dot_product_from_VSH_coeffs +=  dot_product_from_VSH_coeffs_12;
	dot_product_from_VSH_coeffs +=  dot_product_from_VSH_coeffs_20;
	...
	std::cout << "Y_1   dot Psi_2\t:" << dot_product_from_VSH_coeffs_01 << std::endl;
	std::cout << "Y_1   dot Phi_2\t:" << dot_product_from_VSH_coeffs_02 << std::endl;
	std::cout << "Psi_1 dot Y_2  \t:" << dot_product_from_VSH_coeffs_10 << std::endl;
	...
	std::cout << "Phi_1 dot Y_2  \t:" << dot_product_from_VSH_coeffs_20 << std::endl;
