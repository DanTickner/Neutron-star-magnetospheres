...
// g++ Cross_product_of_VSH_series_203_6.cpp -o Cross_product_of_VSH_series_203_6
...
int main(){
	...
	std::vector< std::complex<double> > cross_product_from_VSH_coeffs_20a { 0, 0, 0 };	// until calculation correct
	...
	print_vector_setw( cross_product_from_VSH_coeffs_20a    , w, "Psi_1 x Y_2   (added)" );
