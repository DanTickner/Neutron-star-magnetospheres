// VSH_series_calculation_01.h
// Calculate the VSH series coefficients for a vector A with no r-dependence.
// Initially, we do this with three separate functions.
// Initially, the VSH evaluation and numerical integration are handled by external functions.
...
std::vector< std::vector< std::complex<double> > > generate_vsh_series_Cr( std::vector< std::vector< std::vector<double> > > A, std::vector<double> t_list, std::vector<double> p_list, int ell_max ){
	...
	for( int ell=0; ell<=ell_max; ell++ ){
		...
		for( int m=-ell; m<=ell; m++ ){
			...
			for( int i=0; i<N_t; i++ ){
				for( int j=0; j<N_p; j++ ){
					std::vector<double> A_at_this_point { A[0][i][j], A[1][i][j], A[2][i][j] };
...
std::vector< std::vector< std::complex<double> > > generate_vsh_series_C1( std::vector< std::vector< std::vector<double> > > A, std::vector<double> t_list, std::vector<double> p_list, int ell_max ){
...
std::vector< std::vector< std::complex<double> > > generate_vsh_series_C2( std::vector< std::vector< std::vector<double> > > A, std::vector<double> t_list, std::vector<double> p_list, int ell_max ){
