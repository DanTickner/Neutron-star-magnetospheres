...
fig_folder = "../../../../../Documents/NS_code_offline_results/Figures/20250225" #"../Figures/20241017"
csv_filename_base = "20250220_a_twisted_axisymmetric" #"20250220_a_twisted_axisymmetric"

chosen_header  = "B_r"
chosen_T_index = 1000

#fig_filename = csv_filename_base + "_" + chosen_header + "_" + str( chosen_T_index )
fig_filename = "Twisted_Symm_" + chosen_header + "_" + str( chosen_T_index )
...
#twist_t2 = 0.767944870877505 # Localised NH twist
twist_t2 = 2.61799387799149 # Symmetric twist
...
if highlight_twisted_region:
	...
	ax.plot( arc_inner_x_list, arc_inner_z_list, color="black", ls="-", lw=0.5 )
	ax.plot( arc_outer_x_list, arc_outer_z_list, color="black", ls="-", lw=0.5 )
	ax.plot( [ arc_inner_x_list[ 0], arc_outer_x_list[ 0] ], [ arc_inner_z_list[ 0], arc_outer_z_list[ 0] ], color="black", ls="-", lw=0.5 )
	ax.plot( [ arc_inner_x_list[-1], arc_outer_x_list[-1] ], [ arc_inner_z_list[-1], arc_outer_z_list[-1] ], color="black", ls="-", lw=0.5 )
