...
if chosen_header == "is_gridpoint_within_FF_region":
...
chosen_T = list_T[ list_T_index.index( chosen_T_index ) ]
...
with open( csv_filepath, "r" ) as input_file:
	...
	i_R_LC_history    = headers_history.index( "R_LC"    )
