...
g++ Check_cross_product.cpp -o Check_cross_product --std=c++11
Check_cross_product

Check expressions for the cross product between two vectors A and B.
Use header files for ease of copying to new vectors.
