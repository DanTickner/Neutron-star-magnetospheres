...
g++ Test_Integral_Newton_Cotes.cpp -o Test_Integral_Newton_Cotes --std=c++11
Test_Integral_Newton_Cotes

Test the 1D Newton-Cotes method rule for a known integral.
We only use a linear spacing.
...
int main(){
	...
	//----- Define variables -----
	std::string output_filename_test_log = "../Logs/20240521_Test_Integral_Newton_Cotes.txt";
	...
	double integral_numerical = integral_1D_Newton_Cotes_5( f, delta_x );
