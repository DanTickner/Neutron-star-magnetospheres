...
g++ Test_trapezium_rule_3D_spherical.cpp -o Test_trapezium_rule_3D_spherical --std=c++11
Test_trapezium_rule_3D_spherical
...
int main(){
	...
	//----- Define variables -----
	std::string output_filename_test_log = "../Logs/20240227_Test_trapezium_rule_3D_spherical.txt";
	...
	std::cout            << "i\tj\tk\tu1[i]\tu2[j]\tu3[k]\tf[i][j][k]\tdV[i][j][k]" << std::endl;
	output_file_test_log << "i\tj\tk\tu1[i]\tu2[j]\tu3[k]\tf[i][j][k]\tdV[i][j][k]" << "\n";
