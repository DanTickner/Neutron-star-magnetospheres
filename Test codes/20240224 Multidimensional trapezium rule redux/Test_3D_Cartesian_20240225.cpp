...
g++ Test_3D_Cartesian_20240225.cpp -o Test_3D_Cartesian_20240225 --std=c++11
Test_3D_Cartesian_20240225
...
int main(){
	...
	double u3_min      = 2.5;
	double u3_max      = 6.0;
	int    N_values_u1 = 3;//10;
	int    N_values_u2 = 5;//20;
	int    N_values_u3 = 7;//30;
