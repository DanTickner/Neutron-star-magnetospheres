...
int main(){
	...
	std::string output_filename_test_base = "20240415_Finite_difference_coefficients";	// Don't add ".csv" as the code will append _r, _t, etc to the filename for each csv.
	...
	int N_max = 4;	// Stop generating coefficients once we have considered this many gridpoints. This value is N+1, where N is the maximum distance away from x in a forward or backward difference equation.
