...
g++ Calculate_Finite_Difference_Coefficients_General_Second_Derivative_v2.cpp -o Calculate_Finite_Difference_Coefficients_General_Second_Derivative_v2 --std=c++11
Calculate_Finite_Difference_Coefficients_General_Second_Derivative_v2
...
int main(){
	...
	int N_F    = 2;	// number of gridpoints forward  we look.
	int N_eqns = N_B + N_F - 1;	// The number of simultaneous equations.
	
	double a_N_F = 1;	// change this result to guarantee integers.
	
	std::string output_filename_test_base = "20240430_Finite_difference_coefficients_general_second_derivative_v2";	// Don't add ".csv" as the code will append _r, _t, etc to the filename for each csv.
