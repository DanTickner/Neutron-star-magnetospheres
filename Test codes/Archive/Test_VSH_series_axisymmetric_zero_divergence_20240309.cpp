...
Test the calculation of the VSH series of an axisymmetric spherical polar vector with zero divergence.
Either calculate the (1)-coefficients by finite differencing or by a Chebyshev series. (Comment-out the function calls as appropriate.)
...
int main(){
	...
	int test_type = 0;	// 0 = Original; 1 = Divergenceless with finite differencing; 2 = Divergenceless with Chebyshev decomposition; 
	
	//std::string output_filename_test_base = "20240308_Test_VSH_series_axisymmetric_zero_divergence_FD";
	...
	//----- Choose between FD and Chebyshev decomposition (comment-out as appropriate) -----
