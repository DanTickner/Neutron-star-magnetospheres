...
REASON ARCHIVED: function names changed.
*/
...
int main(){
	...
	int test_type = 2;	// 1 = General; 2 = Divergenceless with finite differencing; 3 = Divergenceless with Chebyshev decomposition; 
