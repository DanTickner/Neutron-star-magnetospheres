...
V24: Using E_ramp_dT is inaccurate. Instead, add to the electric field at each timestep after integration has been performed, with void ramp_up_electric_fields_for_rotation(). See OneNote notes 20231020Fri.
*/
