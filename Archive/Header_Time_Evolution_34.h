...
V34: Swap index order of B_VSH_coeffs[c][i][ell] to B_VSH_coeffs[c][ell][i].
     This is needed because of the function calculate_chebyshev_series_coeffs().
	 Rename calculate_chebyshev_series_coeffs() to chebyshev_series_coeffs() because it returns an object, not void.
*/
...
void VSH_decomposition_for_E(){
	...
	for( int i=0; i<n_points_r; i++ ){
		...
		for( int ell=0; ell<=ell_max; ell++ ){
			...
			E_VSH_coeffs[0][ell][i] = integral_trapezium_1D( VSH_integrand_r, finite_line_element_dt ) * sqrt_2Lplus1_pi[ell];
		...
		for( int ell=1; ell<=ell_max; ell++ ){
			...
			E_VSH_coeffs[1][ell][i] = integral_trapezium_1D( VSH_integrand_1, finite_line_element_dt ) * sqrt_2Lplus1_pi_over_L_Lplus1[ell];
			E_VSH_coeffs[2][ell][i] = integral_trapezium_1D( VSH_integrand_2, finite_line_element_dt ) * sqrt_2Lplus1_pi_over_L_Lplus1[ell];
...
void VSH_decomposition_for_B(){
	...
	for( int i=0; i<n_points_r; i++ ){
		...
		for( int ell=0; ell<=ell_max; ell++ ){
			...
			B_VSH_coeffs[0][ell][i] = integral_trapezium_1D( VSH_integrand_r, finite_line_element_dt ) * sqrt_2Lplus1_pi[ell];
		...
		for( int ell=1; ell<=ell_max; ell++ ){
			...
			B_VSH_coeffs[2][ell][i] = integral_trapezium_1D( VSH_integrand_2, finite_line_element_dt ) * sqrt_2Lplus1_pi_over_L_Lplus1[ell];
