/*
Header_Initial_Conditions_09.h
...
V09: Remove option to set r_max = 2*R_LC, in order to fully disentangle the gridpoints and the time values.
*/
...
std::string output_filename                = "20240612_b_original_radial_derivatives_near_endpoints";
std::string log_file_comment               = "Sme as 20240612_a but with original radial derivative expression near boundaries, and the same profiles frequency to enable direct comparison.";
