...
g++ Time_Evolution_08.cpp -o Time_Evolution_08
Time_Evolution_08
...
V08: Support linear increase in rotation rate.
...
int T_index_Omega_ramp_start = 30;
int T_index_Omega_ramp_stop  = 150;

double T_codeunits_Omega_ramp_start = T_index_Omega_ramp_start * delta_T;
double T_codeunits_Omega_ramp_stop  = T_index_Omega_ramp_stop  * delta_T;
double dOmega_by_dT = Omega / ( T_index_Omega_ramp_start - T_index_Omega_ramp_stop );
...
std::string output_filename = "CSV/20230922";
...
#include "Headers/Header_Time_Evolution_10.h"
