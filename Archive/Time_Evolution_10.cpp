...
g++ Time_Evolution_10.cpp -o Time_Evolution_10 --std=c++11
Time_Evolution_10
...
V10: Include functionality for first-order Adams-Bashforth integration. This is really just the Euler method so no change to the output, but the framework is in place for higher-order Adams-Bashforth methods.
...
#include "Headers/Header_Time_Evolution_13.h"
...
int main(){
	...
	VSH_decomposition( 0, B_r, B_t, B_p, B_r_L, B_1_L, B_2_L );	// 20230922 Trying during troubleshooting why B_1_L coeffs inaccurate.
	
	apply_force_free_conditions_within_force_free_region( 0 );
