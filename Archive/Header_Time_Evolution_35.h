...
V35: Rename VSH_decomposition_for_E() to VSH_decomposition() and pass array by reference. (Passing by value is too slow.)
     Reorder array indexing in output_to_csv_VSH_coeffs(), which had been forgotten.
*/
