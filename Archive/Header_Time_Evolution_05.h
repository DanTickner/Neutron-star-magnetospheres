...
V05: Compatibility with "_profiles" and "_history" csvs.
...
void calculate_n_gridpoints_inside_light_cylinder(){
	...
	std::cout << "Gridpoints inside light cylinder:\t" << n_gridpoints_inside_light_cylinder << "\t(" << 100 * n_gridpoints_inside_light_cylinder / ( (double) n_points_r * n_points_t ) << " %)" << std::endl;
}
